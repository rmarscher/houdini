...
export class ListManager {
    ...
    deleteField(parentID, field) {
        ...
        for (const list of this.listsByField.get(parentID).get(field)) {
            (_c = (_b = this.lists.get(list.name)) === null || _b === void 0 ? void 0 : _b.get(list.parentID)) === null || _c === void 0 ? void 0 : _c.deleteListWithKey(field);
            if (((_e = (_d = this.lists.get(list.name)) === null || _d === void 0 ? void 0 : _d.get(list.parentID)) === null || _e === void 0 ? void 0 : _e.lists.length) === 0) {
                (_f = this.lists.get(list.name)) === null || _f === void 0 ? void 0 : _f.delete(list.parentID);
            }
        }
