...
export declare class Environment {
    ...
    sendRequest<_Data>(ctx: FetchContext, params: FetchParams, session?: FetchSession): Promise<RequestPayload<any>>;
}
...
declare type SapperAfterLoad = (page: FetchContext['page'], session: FetchContext['session'], data: Record<string, any>, input: Record<string, any>) => Record<string, any>;
