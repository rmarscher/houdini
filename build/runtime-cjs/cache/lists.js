...
var List = /** @class */ (function () {
    ...
    List.prototype.removeID = function (id, variables) {
        ...
        if (this.connection) {
            ...
            try {
                for (var _d = __values(stuff_1.flattenList(edges) || []), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var edge = _e.value;
                    if (!edge) {
                        continue;
                    }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!this.connection) {
                        entries = stuff_1.flattenList(value);
                    }
                    else {
...
var ListCollection = /** @class */ (function () {
    ...
    ListCollection.prototype.append = function () {
        ...
        this.lists.forEach(function (list) { return list.append.apply(list, __spread(args)); });
    };
    ListCollection.prototype.prepend = function () {
        ...
        this.lists.forEach(function (list) { return list.prepend.apply(list, __spread(args)); });
    };
    ListCollection.prototype.addToList = function () {
        ...
        this.lists.forEach(function (list) { return list.addToList.apply(list, __spread(args)); });
    };
    ListCollection.prototype.removeID = function () {
        ...
        this.lists.forEach(function (list) { return list.removeID.apply(list, __spread(args)); });
    };
    ListCollection.prototype.remove = function () {
        ...
        this.lists.forEach(function (list) { return list.remove.apply(list, __spread(args)); });
    };
    ListCollection.prototype.toggleElement = function () {
        ...
        this.lists.forEach(function (list) { return list.toggleElement.apply(list, __spread(args)); });
    };
