...
var Cache = /** @class */ (function () {
    function Cache(config) {
        this._internal_unstable = new CacheInternal({
            cache: this,
            config: (0, config_1.defaultConfigValues)(config),
    ...
    Cache.prototype.read = function () {
        ...
        var _b = (_a = this._internal_unstable).getSelection.apply(_a, __spreadArray([], __read(args), false)), data = _b.data, partial = _b.partial, hasData = _b.hasData;
        if (!hasData) {
    ...
    Cache.prototype.list = function (name, parentID) {
        ...
        if (!handler) {
            throw new Error("Cannot find list with name: ".concat(name).concat(parentID ? 'under parent ' + parentID : '', ". ") + 'Is it possible that the query is not mounted?');
        }
        // return the handler
        return handler;
    };
...
var CacheInternal = /** @class */ (function () {
    ...
    CacheInternal.prototype.writeSelection = function (_a) {
        ...
        var _loop_1 = function (field, value) {
            var e_3, _m, e_4, _o, e_5, _p, e_6, _q, e_7, _r, e_8, _s;
            ...
            var _t = selection[field], linkedType = _t.type, keyRaw = _t.keyRaw, fields = _t.fields, operations = _t.operations, isAbstract = _t.abstract, update = _t.update;
            var key = (0, stuff_1.evaluateKey)(keyRaw, variables);
            // the current set of subscribers
            var currentSubcribers = this_1.subscriptions.get(parent, key);
            // look up the previous value
            var _u = this_1.storage.get(parent, key), previousValue = _u.value, displayLayers = _u.displayLayers;
            ...
            if (!fields) {
                ...
                if (displayLayer && (valueChanged || forceNotify)) {
                    ...
                    // we need to invoke
                    toNotify.push.apply(toNotify, __spreadArray([], __read(currentSubcribers), false));
                }
            ...
            // if we are writing `null` over a link
                ...
                var previousLinks = (0, stuff_1.flattenList)([previousValue]);
                try {
                    ...
                    try {
                        if (previousLinks_1_1 && !previousLinks_1_1.done && (_m = previousLinks_1.return)) _m.call(previousLinks_1);
                    }
            ...
            // the field could point to a linked object
                ...
                var linkedID = null;
                if (value !== null) {
                    linkedID = !embedded ? this_1.id(linkedType, value) : "".concat(parent, ".").concat(key);
                }
            ...
            // the field could point to a list of related objects
                ...
                var oldIDs_2 = __spreadArray([], __read((previousValue || [])), false);
                ...
                var _v = this_1.extractNestedListIDs({
                    value: value,
                ...
                }), newIDs = _v.newIDs, nestedIDs = _v.nestedIDs;
                ...
                if (applyUpdates && update) {
                    ...
                    if (key === 'edges') {
                        ...
                        try {
                            ...
                            try {
                                if (newIDs_1_1 && !newIDs_1_1.done && (_o = newIDs_1.return)) _o.call(newIDs_1);
                            }
                ...
                try {
                    ...
                    try {
                        if (oldIDs_1_1 && !oldIDs_1_1.done && (_p = oldIDs_1.return)) _p.call(oldIDs_1);
                    }
                ...
                try {
                    ...
                    for (var _w = (e_6 = void 0, __values(newIDs.filter(function (id) { return !oldIDs_2.includes(id); }))), _x = _w.next(); !_x.done; _x = _w.next()) {
                        var id = _x.value;
                        if (id == null) {
                            continue;
                        }
            ...
            try {
                ...
                for (var _y = (e_7 = void 0, __values(operations || [])), _z = _y.next(); !_z.done; _z = _y.next()) {
                    var operation = _z.value;
                    ...
                    try {
                        ...
                        try {
                            if (targets_1_1 && !targets_1_1.done && (_s = targets_1.return)) _s.call(targets_1);
                        }
    ...
    CacheInternal.prototype.idFields = function (type) {
        return (0, config_2.keyFieldsForType)(this.config, type);
    };
    CacheInternal.prototype.computeID = function (type, data) {
        return (0, config_2.computeID)(this.config, type, data);
    };
    ...
    CacheInternal.prototype.extractNestedListIDs = function (_a) {
        ...
        var _loop_2 = function (i, entry) {
            ...
            if (Array.isArray(entry)) {
                ...
                newIDs.push.apply(newIDs, __spreadArray([], __read(inner.newIDs), false));
            ...
            // @ts-ignore
            var linkedID = "".concat(recordID, ".").concat(key, "[").concat(this_2.storage.nextRank, "]");
