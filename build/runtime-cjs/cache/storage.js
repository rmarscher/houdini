...
var InMemoryStorage = /** @class */ (function () {
    ...
    InMemoryStorage.prototype.get = function (id, field) {
        ...
        var _loop_1 = function (i) {
            ...
            var _b = __read(layer.get(id, field), 2), layerValue = _b[0], kind = _b[1];
            ...
            if (layerOperations.length > 0) {
                try {
                    ...
                    try {
                        if (layerOperations_1_1 && !layerOperations_1_1.done && (_a = layerOperations_1.return)) _a.call(layerOperations_1);
                    }
            ...
            return { value: {
                    value: __spread(operations.insert.start, layerValue, operations.insert.end).filter(function (value) { return !operations.remove.has(value); }),
...
var Layer = /** @class */ (function () {
    ...
    Layer.prototype.writeLink = function (id, field, value) {
        ...
        var _loop_2 = function (value_1) {
            ...
            if (((_d = this_2.operations[value_1]) === null || _d === void 0 ? void 0 : _d.deleted) || this_2.deletedIDs.has(value_1)) {
                // undo the delete
                this_2.operations[value_1] = __assign(__assign({}, this_2.operations[value_1]), { undoDeletesInList: __spread((((_e = this_2.operations[id]) === null || _e === void 0 ? void 0 : _e.undoDeletesInList) || []), [field]) });
        ...
        var this_2 = this;
        try {
            for (var _f = __values(stuff_1.flattenList(valueList)), _g = _f.next(); !_g.done; _g = _f.next()) {
                    ...
                    for (var _l = (e_9 = void 0, __values([this.operations[id], layer.operations[id]].filter(Boolean))), _m = _l.next(); !_m.done; _m = _l.next()) {
                        ...
                        try {
                            for (var _o = (e_10 = void 0, __values(Object.entries(opMap.fields || {}))), _p = _o.next(); !_p.done; _p = _o.next()) {
                                ...
                                fields[fieldName] = __spread((fields[fieldName] || []), operations);
                            }
                        }
    ...
    Layer.prototype.addFieldOperation = function (id, field, operation) {
        ...
        this.operations = __assign(__assign({}, this.operations), (_a = {}, _a[id] = __assign(__assign({}, this.operations[id]), { fields: (_b = {},
                _b[field] = __spread((((_c = this.operations[id]) === null || _c === void 0 ? void 0 : _c.fields[field]) || []), [operation]),
                _b) }), _a));
    };
    return Layer;
}());
