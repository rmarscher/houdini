...
function subscription(document, variables) {
    ...
    var env = (0, network_1.getEnvironment)();
    ...
    var store = (0, store_1.writable)(null);
    // the function to call that unregisters the subscription
    var unsubscribe;
    var marshaledVariables = {};
    $: marshaledVariables = (0, scalars_1.marshalInputs)({
        input: variables || {},
        config: config,
        ...
        unsubscribe = env.socket.subscribe({
            ...
            next: function (_a) {
                ...
                if (data) {
                    ...
                    store.set((0, scalars_1.unmarshalSelection)(config, artifact.selection, data));
                }
            },
            error: function (data) { },
            complete: function () { },
