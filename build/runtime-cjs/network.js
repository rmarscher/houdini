...
function executeQuery(artifact, variables, sessionStore, cached) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    session = (0, store_1.get)(sessionStore);
                    fetchCtx = {
...
var RequestContext = /** @class */ (function () {
                    ...
                    case 0:
                        if (framework === 'kit') {
                            if (variant === 'before') {
                                ...
                                hookCall = hookFn.call(this, __assign(__assign({}, this.context), { input: input, data: data }));
                            }
                        }
                        else {
                            // sapper
    ...
    RequestContext.prototype.computeInput = function (_a) {
        ...
        return (0, scalars_1.marshalInputs)({ artifact: artifact, config: config, input: input });
    };
