...
function paginatedQuery(document) {
    ...
    var _a = (0, query_1.query)(document), data = _a.data, loading = _a.loading, refetch = _a.refetch, partial = _a.partial, onLoad = _a.onLoad, restOfQueryResponse = __rest(_a, ["data", "loading", "refetch", "partial", "onLoad"]);
    var paginationPartial = (0, store_1.writable)(false);
...
function paginatedFragment(document, initialValue) {
    ...
    var data = (0, fragment_1.fragment)(document, initialValue);
    // @ts-ignore: typing esm/cjs interop is hard
    ...
    var partial = (0, store_1.writable)(false);
    ...
    if (!typeConfig) {
        throw new Error("Missing type refetch configuration for ".concat(targetType, ". For more information, see https://www.houdinigraphql.com/guides/pagination#paginated-fragments"));
    }
    ...
    if (paginationArtifact.refetch.embedded) {
        ...
        if ((_b = typeConfig.resolve) === null || _b === void 0 ? void 0 : _b.arguments) {
            ...
            var keys_1 = (0, config_1.keyFieldsForType)(document.config, targetType || '');
            // @ts-ignore
...
function paginationHandlers(_a) {
    ...
    var pageInfo = (0, store_1.readable)({
        startCursor: null,
        endCursor: null,
        hasNextPage: false,
    ...
    // loading state
    var paginationLoadingState = (0, store_1.writable)(false);
    var refetchQuery;
    ...
    if (!documentLoading) {
        documentLoading = (0, store_1.readable)(false, function () { });
    }
    // merge the pagination and document loading state
    var loading = (0, store_1.derived)([paginationLoadingState, documentLoading], function ($loadingStates) { return $loadingStates[0] || $loadingStates[1]; });
...
function cursorHandlers(_a) {
    ...
    var variables = (0, context_1.getVariables)();
    var sessionStore = (0, adapter_mjs_1.getSession)();
    // track the current page info in an easy-to-reach store
    var initialPageInfo = (_b = (0, utils_1.extractPageInfo)(initialValue, artifact.refetch.path)) !== null && _b !== void 0 ? _b : {
        startCursor: null,
        endCursor: null,
        hasNextPage: false,
        hasPreviousPage: false,
    };
    var pageInfo = (0, store_1.writable)(initialPageInfo);
    // hold onto the current value
    var value = initialValue;
    store.subscribe(function (val) {
        pageInfo.set((0, utils_1.extractPageInfo)(val, artifact.refetch.path));
        value = val;
    });
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, network_1.executeQuery)(artifact, queryVariables, sessionStore, false)];
                    case 1:
                        _b = _e.sent(), result = _b.result, partialData = _b.partial;
                        partial.set(partialData);
                        resultPath = __spreadArray([], __read(artifact.refetch.path), false);
                        if (artifact.refetch.embedded) {
                            ...
                            if (!((_d = (_c = config.types) === null || _c === void 0 ? void 0 : _c[targetType]) === null || _d === void 0 ? void 0 : _d.resolve)) {
                                throw new Error("Missing type resolve configuration for ".concat(targetType, ". For more information, see https://www.houdinigraphql.com/guides/pagination#paginated-fragments"));
                            }
                        ...
                        pageInfo.set((0, utils_1.extractPageInfo)(result.data, resultPath));
    ...
    return {
        ...
        loadNextPage: function (pageCount) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        currentPageInfo = (0, utils_1.extractPageInfo)(value, artifact.refetch.path);
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            count = (0, utils_1.countPage)(artifact.refetch.path.concat('edges'), value) ||
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            count = (0, utils_1.countPage)(artifact.refetch.path, value);
...
function missingPageSizeError(fnName) {
    return new Error('Loading a page with no page size. If you are paginating a field with a variable page size, ' +
        "you have to pass a value to `".concat(fnName, "`. If you don't care to have the page size vary, ") +
