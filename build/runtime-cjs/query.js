...
function query(document) {
    ...
    var store = store_1.writable(scalars_1.unmarshalSelection(config, artifact.selection, initialValue));
    ...
    function writeData(newData, newVariables) {
        ...
        store.set(scalars_1.unmarshalSelection(config, artifact.selection, newData.data));
    ...
    return {
        ...
        error: store_1.readable(null, function () { }),
...
exports.routeQuery = function (_a) {
...
exports.componentQuery = function (_a) {
    ...
    var loading = store_1.writable(true);
    // a store to track the error state
    var error = store_1.writable(null);
    ...
    $: {
        ...
        variables = scalars_1.marshalInputs({
            artifact: artifact,
            config: config,
            input: (variableFunction === null || variableFunction === void 0 ? void 0 : variableFunction.call(variableContext, {
                page: store_1.get(adapter_mjs_1.getPage()),
                session: store_1.get(adapter_mjs_1.getSession()),
                props: getProps(),
            })) || {},
        });
    }
